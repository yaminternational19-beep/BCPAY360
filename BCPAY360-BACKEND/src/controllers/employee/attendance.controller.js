...
export const checkOut = async (req, res) => {
  ...
  try {
    ...
    const shiftEndMin = timeToMinutes(att.shift_end || "18:00");
    ...
    const [[todayAttendance]] = await db.query(
      ...
      SELECT
        ...
        CASE
          ...
          WHEN session_status = 'IN_PROGRESS' AND is_late = 1 THEN 'LATE'
          WHEN session_status = 'IN_PROGRESS' AND is_late = 0 THEN 'CHECKED_IN'
          WHEN session_status = 'COMPLETED' AND attendance_status = 'HALF_DAY' THEN 'HALF_DAY'
          WHEN session_status = 'COMPLETED' THEN 'CHECKED_OUT'
